...
class Var(object):
    MULTI_CLIENT = False
    API_ID = int(environ.get("1222723"))
    API_HASH = str(environ.get("67e6a613a39747035a30ad8eac363678"))
    BOT_TOKEN = str(environ.get("6901144310:AAGIKfVppHbFLI0tiv_0F7HnTxMVSXZ9mTI"))
    SLEEP_THRESHOLD = int(environ.get("SLEEP_THRESHOLD", "60"))  # 1 minte
    WORKERS = int(environ.get("WORKERS", "6"))  # 6 workers = 6 commands at once
    BIN_CHANNEL = int(
        environ.get("BIN_CHANNEL", "-1002133996735")
